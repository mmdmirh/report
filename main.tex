...
Second, we introduce \textbf{FormScript}, a semantic intermediate representation that transforms raw pose measurements into interpretable \emph{FormCodes}---discrete biomechanical descriptors enabling rule-based form analysis and exercise-specific reasoning.
