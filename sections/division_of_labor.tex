...
\begin{itemize}
    ...
    \item Empirical model analysis and experiments reported in Sec.~\ref{sec:sec:movenet-postproc}, covering multi-backend benchmarking, stability evaluation, and latency measurement.
\end{itemize}
