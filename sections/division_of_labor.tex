...
\begin{itemize}
    ...
    \item Empirical model analysis and experiments reported in Sec.~\ref{sec:model-eval}, covering multi-backend benchmarking, stability evaluation, and latency measurement.
\end{itemize}
