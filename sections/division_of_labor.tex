...
\begin{itemize}
    ...
    \item Design and implementation of the normalized repetition counting module, including an online state-machine for cycle detection driven by calibrated thresholds, normalized progress estimation, and timing-based robustness checks.
    \item Refactoring and integration of multiple 2D pose estimators into a unified, estimator-agnostic backend pipeline, eliminating duplicated command and frame-processing logic and improving code maintainability without introducing new features.
\end{itemize}
