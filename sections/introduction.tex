...
Central to this approach is \textbf{FormScript}, a semantic intermediate representation that transforms raw pose measurements into interpretable \emph{FormCodes}---discrete biomechanical descriptors that enable rule-based form analysis and exercise-specific reasoning.
